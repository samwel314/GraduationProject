...
namespace TravelLinkerDataAccess.Data.Migrations
{
    ...
    [Migration("20240617134738_AddRoomTransaction")]
    partial class AddRoomTransaction
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TravelLinkerModels.Models.Rate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TravelLinkerModels.Models.RoomSchedule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("RoomSchedules", "Hsc");
                });

            modelBuilder.Entity("TravelLinkerModels.Models.RoomTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TravelLinkerModels.Models.RoomTransaction", b =>
                {
                    ...
                    b.HasOne("TravelLinkerModels.Models.RoomSchedule", "Schedule")
                        .WithOne()
                        .HasForeignKey("TravelLinkerModels.Models.RoomTransaction", "ScheduleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
